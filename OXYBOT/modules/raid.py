...
async def raid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in OXYGEN:
                await e.reply("TOXIC KA REPO  HAI YE.")
            elif uid == OWNER_ID:
                await e.reply("BAAP PE KAREGA RAID TERI MAA CHOD DUNGA...")
            elif uid in SUDO_USERS:
                await e.reply("TOXIC KA DOST HAI BSDK RAID MT MAAR.. !!...")
            else:
    ...
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            if user_id in OXYGEN:
                ...
                await e.reply("» LAG GYA REPLY RAID MADHARCHOD PE.. !! ✅")
        except NameError:
...
async def drraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply("» HAT GYA REPLY RIAD MADHARCHOD SE !! ✅")
        except NameError:
