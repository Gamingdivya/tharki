...
from OXYBOT.data import BDAY, HRAID
...
async def hraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in DEV:
                await e.reply("ɴᴏᴘᴇ, 🇹 𝙾 𝚇 𝙸 𝙲 ɪꜱ ᴀᴜᴛʜᴏʀ ʙᴏᴛ ᴏᴡɴᴇʀ🍷 ")
            elif uid == OWNER_ID:
                await e.reply("ɴᴏᴘᴇ, 🇹 𝙾 𝚇 𝙸 𝙲 ɪꜱ ᴏᴡɴᴇʀ ᴏꜰ ᴛʜᴇꜱᴇ ʙᴏᴛꜱ 🤖")
            elif uid in SUDO_USERS:
                await e.reply("ɴᴏᴘᴇ, 🇹 𝙾 𝚇 𝙸 𝙲 🇰 𝙰 🇩 𝙾 𝚂 𝚃 🇭 𝚄 🇧 𝙷 𝙾 𝚂 𝙳 𝙺  🫂")
            else:
