...
HELP_STRING = f"🇹 𝙾 𝚇 𝙸 𝙲 🇸 𝙿 𝙰 𝙼  🇧 𝙾 𝚃˼ 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **𝐂𝐋𝐈𝐂𝐊 𝐎𝐍 𝐁𝐔𝐓𝐓𝐎𝐍 𝐅𝐎𝐑 𝐇𝐄𝐋𝐏**\n» **𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥: ˹@llll_SHADOW_OP_X_D_llll ˼🫧**"
...
HELP_BUTTON = [
  ...
  [   
      Button.inline("★𝗡𝗘𝗪 𝗖𝗢𝗠𝗠𝗔𝗡𝗗★", data="tharki")
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Developer - @llll_SHADOW_OP_X_D_llll★" , cache_time=0, alert=True)
