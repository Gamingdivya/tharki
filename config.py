...
API_ID = 29314423
API_HASH = "8bcb74a1754beafa2146c7e57a6ab70d"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5059737154").split()))
for x in OXYGEN:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="6382667316"))
